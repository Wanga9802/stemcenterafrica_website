          ...
          <div className="collapse navbar-collapse">
            <ul className="navbar-nav ms-auto align-items-lg-center gap-lg-1">
             ...
             {/* About */}
              ...
              {/* WoStem */}
              <li className="nav-item">
                <NavLink className={({ isActive }) => `nav-link${isActive ? ' active' : ''}`} to="/girlsinstem">Girls in STEM</NavLink>
              </li>
      ...
      <div className={`mobile-drawer${mobileMenuOpen ? ' open' : ''}`} role="dialog" aria-modal="true" aria-labelledby="mobileMenuLabel">
        ...
        <div className="offcanvas-body">
          ...
          <ul className="navbar-nav d-flex flex-column gap-1">
            ...
            {/* WoSTEM */}
            <li className="nav-item">
              <NavLink className={({ isActive }) => `nav-link offcanvas-link${isActive ? ' active' : ''}`} to="/girlsinstem" onClick={closeMobileMenu}>Girls in STEM</NavLink>
            </li>
