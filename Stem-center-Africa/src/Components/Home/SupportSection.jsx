        ...
        <div className="supp-right">
          ...
          <div className="supp-right-content">
            ...
            <div className="supp-social-row">
              <a href="https://www.facebook.com/STEMCenter20" aria-label="Facebook" className="supp-social-icon">
              ...
              <a href="https://www.linkedin.com/in/stem-center-africa" aria-label="LinkedIn" className="supp-social-icon">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="#ffffff"><path d="M4.98 3.5a2.5 2.5 0 110 5 2.5 2.5 0 010-5zM3 8.75h4V21H3v-12.25zM9 8.75h3.75v1.7h.05c.52-.98 1.8-2 3.7-2 4 0 4.75 2.6 4.75 6V21h-4v-5.25c0-1.25-.02-2.85-1.75-2.85-1.75 0-2.02 1.37-2.02 2.78V21H9v-12.25z"/></svg>
              </a>
              <a href="http://www.youtube.com/@stemcenterafrica6823" aria-label="YouTube" className="supp-social-icon">
