...
export const SERVICE_DETAIL_CONFIG = {
  ...
  'software-development': {
    ...
    customizeDescription: 'Build the right software package for your business with tailored features, roles, and integrations.',
    ctaPrefix: 'Ready to get started with the right',
    ctaSuffix: 'package',
    packages: [
      {
        ...
        price: 150000,
        tier: 'Software development',
        description: 'Web-based software for a single module with essential business functionality.',
        features: [
          'Web-based software (single module)',
          'Up to 5 core features',
          'Basic UI with brand colors and logo',
          'Simple database setup',
          'Contact forms or basic workflows',
          'User access (1 role)',
          'Basic testing',
          'Deployment on client or Tupo Host server',
          'Timeline: 2–3 weeks',
        ],
      },
      {
        key: 'business',
        label: 'STANDARD BUSINESS SOFTWARE',
        price: 350000,
        tier: 'Software development',
        description: 'A custom business application with user roles, dashboards, and integrations.',
        isRecommended: true,
        features: [
          'Custom web application',
          'Up to 10–12 features/modules',
          'Custom UI/UX',
          'User authentication and roles (Admin + Staff)',
          'CRUD system',
          'Reports and basic dashboard',
      ...
      {
        key: 'advanced',
        label: 'PROFESSIONAL SOFTWARE DEVELOPMENT',
        price: 700000,
        tier: 'Software development',
        description: 'Advanced software with automation, payments, analytics, and full backend optimization.',
        features: [
          'Advanced custom software',
          'Multi-user roles and permissions',
          'Workflow automation',
          'Payment integration (M-Pesa, Stripe, Paystack, PayPal)',
      ...
      {
        key: 'advanced-software',
        label: 'ADVANCED SOFTWARE DEVELOPMENT',
        price: 1500000,
        tier: 'Software development',
        description: 'Full custom architecture and modular, scalable systems for growing businesses.',
        features: [
          'Full custom architecture',
          'Modular and scalable system',
          'Multi-tenant setup for SaaS',
          'Advanced security and access control',
          'Third-party integrations (CRM, accounting, SMS, payment gateways)',
          'Performance optimization',
      ...
      },
      {
        ...
        tier: 'software development',
        priceLabel: 'FROM',
        description: 'Enterprise-grade systems with cloud infrastructure, integrations, and SLA-backed support.',
        features: [
          'Enterprise-grade architecture',
          'High availability and scalability',
          'Cloud infrastructure (AWS, GCP, Azure)',
          'Custom integrations (ERP, SAP, legacy systems)',
          'Security audits and compliance',
          'Load testing and optimization',
          'Dedicated project manager',
          'SLA-based support and maintenance',
          'Long-term roadmap and versioning',
        ],
      },
    ],
    modules: [
